...
function ProductDetail() {
  ...
  return (
    <div className={`${theme === "dark" ? "bg-[#0a0a0a]" : "bg-zinc-50"}`}>
      ...
      <div className="w-full max-w-7xl mx-auto p-4">
        <div className="gradient-border">
          <div
            className={`bg-gradient-to-r ${theme === "dark" ? "from-zinc-900 to-zinc-800" : "from-zinc-100 to-white"} rounded-xl overflow-hidden shadow-[0_0_50px_rgba(225,29,72,0.15)]`}
          >
            <div className="p-8 md:p-12 flex flex-col md:flex-row items-center relative">
              ...
              <div
                className={`md:w-1/2 ${theme === "dark" ? "text-white" : "text-zinc-900"} mb-8 md:mb-0 z-10`}
              >
                <div className="inline-block px-3 py-1 bg-rose-700 text-white text-xs font-semibold rounded-full mb-4">
                  FLAGSHIP LUXURY
                </div>
                <h1
                  className={`text-3xl md:text-4xl lg:text-5xl font-bold mb-4 ${theme === "dark" ? "text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-white" : "text-zinc-900"}`}
                >
                  {product.name}
                </h1>
                ...
                <p
                  className={`${theme === "dark" ? "text-zinc-400" : "text-zinc-600"} text-lg mb-6 border-l-4 border-rose-600 pl-4`}
                >
                  {product.description}
                </p>
                <div className="flex items-center">
                  <span
                    className={`text-3xl md:text-4xl font-bold ${theme === "dark" ? "text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-white" : "text-zinc-900"}`}
                  >
                    {formattedPrice}
                  </span>
                  <span
                    className={`ml-2 ${theme === "dark" ? "text-zinc-500" : "text-zinc-600"}`}
                  >
                    plus taxes & fees
                  </span>
                </div>
                ...
                <div className="flex gap-4 mt-6">
                  <div
                    className={`flex items-center ${theme === "dark" ? "text-zinc-400" : "text-zinc-600"}`}
                  >
              ...
              <div className="md:w-1/2 flex justify-center z-10">
                <div className="relative hover:scale-105 transition-transform duration-700">
                  ...
                  />
                  <div
                    className={`absolute -bottom-4 -left-4 -right-4 h-20 bg-gradient-to-t rounded-lg ${theme === "dark" ? "from-zinc-900" : "from-zinc-50"} to-transparent z-20`}
                  ></div>
                </div>
              </div>
            </div>
      ...
      <div className="w-full max-w-7xl mx-auto p-4 mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <div
            className={`${theme === "dark" ? "bg-zinc-900" : "bg-white"} rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.3)] p-6 hover-lift`}
          >
            <div className="flex items-center mb-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div
                className={`flex flex-col items-center p-4 ${theme === "dark" ? "bg-zinc-800 border-zinc-700" : "bg-zinc-100 border-zinc-200"} rounded-lg border`}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {(showAllFeatures ? CAR_FEATURES : CAR_FEATURES.slice(0, 6)).map(
                (feature, index) => (
                  <div
                    key={index}
                    className={`flex items-start ${theme === "dark" ? "bg-zinc-800 border-zinc-700" : "bg-zinc-100 border-zinc-200"} p-3 rounded-lg border`}
                  >
        ...
        <div className="space-y-8">
          <div
            className={`${theme === "dark" ? "bg-zinc-900" : "bg-white"} rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.3)] p-6 top-4 hover-lift`}
          >
            <h2
              className={`text-xl font-bold ${theme === "dark" ? "text-white" : "text-zinc-900"} mb-4 flex items-center`}
            >
            ...
            <div className="mb-6">
              <h3
                className={`text-sm font-medium ${theme === "dark" ? "text-zinc-500" : "text-zinc-600"} mb-2`}
              >
                Available Colors
              </h3>
              <div className="flex flex-wrap gap-2 mb-2">
                {CAR_COLORS.map((color, index) => (
                  <button
                    ...
                    className={`w-8 h-8 rounded-full border-2 ${selectedColor === index ? "border-rose-500 ring-2 ring-rose-500/30" : theme === "dark" ? "border-zinc-700" : "border-zinc-300"}`}
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                ...
                <div
                  className={`border-t ${theme === "dark" ? "border-zinc-800" : "border-zinc-200"} pt-2 mt-2 flex justify-between font-semibold`}
                >
                  <span
                    className={`${theme === "dark" ? "text-zinc-400" : "text-zinc-600"}`}
                  >
            ...
            <div className="space-y-3">
              ...
              <button
                className={`w-full ${theme === "dark" ? "bg-zinc-800 border-zinc-700" : "bg-zinc-200 border-zinc-300"} border text-${theme === "dark" ? "white" : "zinc-900"} hover:${theme === "dark" ? "bg-zinc-700" : "bg-zinc-300"} font-medium py-3 px-4 rounded-lg transition-colors`}
              >
                Schedule Test Drive
              </button>
              <div className="flex gap-2 mt-4">
                <button
                  className={`flex-1 flex justify-center items-center gap-1 ${theme === "dark" ? "bg-zinc-800 hover:bg-zinc-700 text-zinc-300" : "bg-zinc-200 hover:bg-zinc-300 text-zinc-700"} py-2 px-3 rounded-lg transition-colors`}
                >
          ...
          >
            ...
            <div className="space-y-4">
              <div
                className={`p-4 border ${theme === "dark" ? "border-rose-900/50 bg-gradient-to-br from-zinc-800 to-zinc-900" : "border-rose-300/50 bg-gradient-to-br from-zinc-100 to-white"} rounded-lg shadow-lg ${theme === "dark" ? "shadow-rose-900/10" : "shadow-rose-300/10"}`}
              >
                <div className="font-semibold text-rose-400 mb-1">
                  36-Month Financing
                </div>
                <div
                  className={`text-2xl font-bold ${theme === "dark" ? "text-white" : "text-zinc-900"} mb-2`}
                >
                  $2,899/mo
                </div>
                <div
              ...
              <div
                className={`p-4 border ${theme === "dark" ? "border-zinc-800 bg-zinc-800/50" : "border-zinc-300 bg-zinc-100/50"} rounded-lg`}
              >
                <div
                  className={`font-semibold ${theme === "dark" ? "text-zinc-400" : "text-zinc-600"} mb-1`}
                >
                  48-Month Financing
                </div>
                <div
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/3">
              <div className="flex flex-col items-center">
                <div
                  className={`text-5xl font-bold ${theme === "dark" ? "text-white" : "text-zinc-900"} mb-2`}
                >
                  {rating}
                </div>
                ...
                <div className="w-full mt-6 space-y-2">
                  <div className="flex items-center">
                    ...
                    <div
                      className={`flex-1 h-2 mx-2 ${theme === "dark" ? "bg-zinc-800" : "bg-zinc-200"} rounded-full overflow-hidden`}
                    >
                      <div
            ...
            <div className="md:w-2/3">
              <div className="space-y-6">
                {REVIEWS.map((review) => (
                  <div
                    key={review.id}
                    className={`border-b ${theme === "dark" ? "border-zinc-800" : "border-zinc-200"} pb-6`}
                  >
      ...
      <div className="w-full max-w-7xl mx-auto p-4 mt-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {SIMILAR_CARS.map((car) => (
            <div
              key={car.id}
              className={`${theme === "dark" ? "bg-zinc-900" : "bg-white"} rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.3)] overflow-hidden hover-lift group`}
            >
              ...
              <div className="p-4">
                <h3
                  className={`font-bold text-lg mb-1 ${theme === "dark" ? "text-white" : "text-zinc-900"}`}
                >
                  {car.name}
                </h3>
                <div className="flex mb-2">{renderRating(car.rating)}</div>
                <p
                  className={`${theme === "dark" ? "text-zinc-500" : "text-zinc-600"} mb-3`}
                >
      ...
      <div
        className={`w-full ${theme === "dark" ? "bg-zinc-950 border-zinc-800" : "bg-zinc-100 border-zinc-200"} border-t py-8 relative overflow-hidden`}
      >
          ...
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              ...
              >
                ...
                />
                <path
                  d="M19 15H21V17H19V15Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M23 15H25V17H23V15Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M27 15H29V17H27V15Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M11 19H13V21H11V19Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M15 19H17V21H15V19Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                ...
                />
                <path
                  d="M23 19H25V21H23V19Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M27 19H29V21H27V19Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M11 23H13V25H11V23Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M15 23H17V25H15V23Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M19 23H21V25H19V23Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M23 23H25V25H23V23Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
                <path
                  d="M27 23H29V25H27V23Z"
                  fill={theme === "dark" ? "white" : "black"}
                />
              </pattern>
            </defs>
