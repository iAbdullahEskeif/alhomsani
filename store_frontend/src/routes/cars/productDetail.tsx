          ...
          <Card className="bg-zinc-900 border-zinc-800 shadow-md">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  {CAR_COLORS.map((color, index) => (
                    <button
                      ...
                      className={`size-8 rounded-full border-2 ${selectedColor === index ? "border-zinc-400 ring-2 ring-zinc-400/30" : "border-zinc-700"}`}
              ...
              <div>
                ...
                <div className="flex items-center">
                  <span
                    className={`inline-block size-3 rounded-full ${product.availability === "in_stock" ? "bg-emerald-500" : "bg-zinc-500"} mr-2`}
                  ></span>
